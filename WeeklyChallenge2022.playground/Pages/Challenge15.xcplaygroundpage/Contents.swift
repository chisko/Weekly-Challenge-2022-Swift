...
func diasEntre(fecha1: String, y fecha2: String) -> Int {
    let dateFormatter = DateFormatter()
    dateFormatter.dateFormat = "dd/MM/yyyy"
    
    guard let date1 = dateFormatter.date(from: fecha1) else { return 0 }
    guard let date2 = dateFormatter.date(from: fecha2) else { return 0 }
...
print(diasEntre(fecha1: "26/10/1988", y: "10/12/1987"))
print(diasEntre(fecha1: "10/12/1987", y: "04/11/2016"))
print(diasEntre(fecha1: "10/12/1987", y: "14/01/2020"))
